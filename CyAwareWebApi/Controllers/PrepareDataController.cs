...
namespace CyAwareWebApi.Controllers
{
    public class DataController : ApiController
    {
        ...
        private int createEntities(Subscriber subscriber, bool isFlatEntities)
        {
            ...
            instagram1 = new EInstagramProfile { entityType = "ETwitterProfile", idStr = "2255540131", screenName = "TURKCELL INST1", dailyMaxPosts = 150, dailyMaxCAPITALLETTERRatio = 20, dailyMaxFalloweeChangeRatio = 10, dailyMaxFollowerChangeRatio = 10, searchStringForUnusualContent = "hacked,anonymous,telsim,vodafone,avea", subscriber = subscriber, Id = -12, mainEntityId = null };
            instagram2 = new EInstagramProfile { entityType = "ETwitterProfile", idStr = "505129896", screenName = "TURKCELL INST2", dailyMaxPosts = 150, dailyMaxCAPITALLETTERRatio = 20, dailyMaxFalloweeChangeRatio = 10, dailyMaxFollowerChangeRatio = 10, searchStringForUnusualContent = "hacked,anonymous,telsim,vodafone,avea", subscriber = subscriber, Id = -13, mainEntityId = null };
